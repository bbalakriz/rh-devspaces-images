...
RUN cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	 && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	build && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensioncode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-activity-tracker && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-api && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-commandcode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-port && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-remote && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-resource-monitor && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-terminal && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/che-github-authentication && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/configuration-editing && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/css-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/css-language-features/server && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/debug-auto-launch && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/debug-server-ready && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/emmet && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/extension-editing && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/git && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/git-base && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/github && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/github-authentication && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/grunt && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/gulp && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/html-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/html-language-features/server && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/ipynb && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/jake && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/json-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/json-language-features/server && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/markdown-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/markdown-math && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/media-preview && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/merge-conflict && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/microsoft-authentication && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/notebook-renderercode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/npm && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/php-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/references-view && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/search-result && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/simple-browser && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/tunnel-forwarding && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/typescript-language-featurecode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/vscode-api-testcode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/vscode-colorize-testcode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/vscode-colorize-perf-testcode/code/ && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	extensions/vscode-test-resolver && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	remote && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	remote/web && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	test/automation && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	test/integration/browser && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	test/monaco && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	test/smoke && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	.vscode/extensions/vscode-selfhost-import-aid && npm install \
    && cd $REMOTE_SOURCES_DIR/devspaces-images-code/app/	.vscode/extensions/vscode-selfhost-test-provider && npm install 
